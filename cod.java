...
public class CadastroVeiculos extends JFrame {
    ...
    private JTextField campoMarca, campoModelo, campoAtributo;
    private DefaultListModel<Veiculo> listaModel;
    private JList<Veiculo> listaVeiculos;
    private JButton cadastrar, listar, alterar, remover, limpar;
